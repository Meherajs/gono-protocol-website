...
pub mod pallet {
    ...
    pub type AnalystCredit<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        FixedU128,
    ...
    pub type ReporterCredit<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        FixedU128,
    ...
    pub type ContentCredibility<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        CidOf<T>,
        FixedU128,
    ...
    pub type VerifierCount<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        CidOf<T>,
        u32,
    ...
    pub type VerifierApprovals<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        CidOf<T>,
        u32,
    ...
    pub type TotalActiveVerifiers<T: Config> = StorageValue<
        _,
        u32,
        ValueQuery,
    >;
    ...
    pub type HasVotedBefore<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        bool,
    ...
    pub type ContentReporter<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        CidOf<T>,
        T::AccountId,
    ...
    pub type ContentSubmittedAt<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        CidOf<T>,
        BlockNumberFor<T>,
    ...
    pub type ContentFinalized<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        CidOf<T>,
        bool,
    ...
    pub type AnalystStats<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        (u32, u32),
    ...
    pub type AnalystPositiveCredit<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        FixedU128,
    ...
    pub type ReporterPublishedContents<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        u32,
    ...
    pub type ReporterCreditSum<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        FixedU128,
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn vote_as_verifier(
            ...
            ensure!(ContentReporter::<T>::contains_key(&cid), Error::<T>::ContentNotFound);
            ensure!(!ContentFinalized::<T>::get(&cid), Error::<T>::ContentAlreadyFinalized);
            ensure!(!VerifierScores::<T>::contains_key(&cid, &who), Error::<T>::AlreadyVoted);

            VerifierScores::<T>::insert(&cid, &who, score_binary);
            VerifierCount::<T>::mutate(&cid, |count| *count = count.saturating_add(1));

            if score_binary == 1 {
                VerifierApprovals::<T>::mutate(&cid, |approvals| *approvals = approvals.saturating_add(1));
            }
        ...
        pub fn submit_analyst_review(
            ...
            ensure!(!AnalystReviews::<T>::contains_key(&cid, &who), Error::<T>::AlreadyReviewed);
        ...
        pub fn finalize_content_score(
            ...
            if !is_root {
                ...
                let submitted_at = ContentSubmittedAt::<T>::get(&cid)
            ...
            ensure!(n_n >= T::MinVerifiers::get(), Error::<T>::InsufficientVerifiers);
